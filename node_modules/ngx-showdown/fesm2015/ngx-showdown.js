import { Injectable, Optional, SecurityContext, Component, ElementRef, Input, EventEmitter, Directive, Output, Pipe, NgModule } from '@angular/core';
 ...
 * ```
 */
class ShowdownConverter extends Converter {
    constructor(config) {
